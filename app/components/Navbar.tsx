...
export default function Navbar() {
    return (
        <header className="sticky top-0 py-10 border-b z-10 bg-white dark:bg-slate-950">
            <nav className="container mx-auto flex justify-between items-center">
                <Link href="/" className="font-bold text-3xl">Marc <span className="text-primary">Brigham</span></Link>
