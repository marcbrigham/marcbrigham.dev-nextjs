export const projects = [
    ...
    },
    {
        ...
        image: "/OKState_devices.jpg",
        link: "https://okstate.com/",
    },
    {
      title: "Baylor University Athletics",
      subtitle: "HTML, LESS, & Knockout.js",
      description:
        "My work on baylorbears.com involved crafting a seamless online experience that resonates with the university's athletic community, showcasing events, news, and athlete profiles with a modern touch.",
      image: "/Baylor_devices.jpg",
      link: "https://baylorbears.com/",
    },
    {
      title: "Post Game",
      ...
      link: "https://www.fantasypros.com/nfl/myplaybook/post-game.php",
    },
    {
